...
public class SolverIntegrationTests
{
    ...
    public void TestDisplayFilteringWithAngleEquality()
    {
        ...
        var displayAngles = new HashSet<TriangleSolver.Solver.Angle>
        {
            TriangleSolver.Solver.Angle.FromString("FAE"), // Triangle AFE angle at A
            TriangleSolver.Solver.Angle.FromString("FEB"), // Variable angle at E
            TriangleSolver.Solver.Angle.FromString("CBA")  // Triangle ABC angle at B
        };
        ...
        foreach (var solverEntry in solverResults)
        {
            ...
            {
                var testAngle = TriangleSolver.Solver.Angle.FromString(angleKey);
    ...
    public void TestSegmentEqualityInDisplay()
    {
        ...
        var displaySegments = new HashSet<TriangleSolver.Solver.Segment>
        {
            TriangleSolver.Solver.Segment.FromString("AF"),
            TriangleSolver.Solver.Segment.FromString("EF")
        };
        ...
        foreach (var solverEntry in solverResults)
        {
            ...
            {
                var testSegment = TriangleSolver.Solver.Segment.FromString(segmentKey);
